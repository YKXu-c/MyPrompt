...
1. Read plans/ to confirm the develop rules and style. And understand current developing phase.
2. The aim is to read a hr.dat and orbital_metadatas(a parameter of BaseTensor), then store it into a Lattice.model.HoppingModel.build_HR
...
3. translate them into a hoppingModel
